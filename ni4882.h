...
//
void NI488CC AllSpoll       (int boardID, const short * addrlist, short * results);
void NI488CC DevClear       (int boardID, short addr);
void NI488CC DevClearList   (int boardID, const short * addrlist);
void NI488CC EnableLocal    (int boardID, const short * addrlist);
void NI488CC EnableRemote   (int boardID, const short * addrlist);
void NI488CC FindLstn       (int boardID, const short * addrlist, short * results, size_t limit);
void NI488CC FindRQS        (int boardID, const short * addrlist, short * dev_stat);
void NI488CC PPoll          (int boardID, short * result);
void NI488CC PPollConfig    (int boardID, short addr, int dataLine, int lineSense);
void NI488CC PPollUnconfig  (int boardID, const short * addrlist);
void NI488CC PassControl    (int boardID, short addr);
void NI488CC RcvRespMsg     (int boardID, void * buffer, size_t cnt, int Termination);
void NI488CC ReadStatusByte (int boardID, short addr, short * result);
void NI488CC Receive        (int boardID, short addr, void * buffer, size_t cnt, int Termination);
void NI488CC ReceiveSetup   (int boardID, short addr);
void NI488CC ResetSys       (int boardID, const short * addrlist);
void NI488CC Send           (int boardID, short addr, const void * databuf, size_t datacnt, int eotMode);
...
void NI488CC SendList       (int boardID, const short * addrlist, const void * databuf, size_t datacnt, int eotMode);
void NI488CC SendSetup      (int boardID, const short * addrlist);
void NI488CC SetRWLS        (int boardID, const short * addrlist);
void NI488CC TestSRQ        (int boardID, short * result);
void NI488CC TestSys        (int boardID, const short * addrlist, short * results);
void NI488CC Trigger        (int boardID, short addr);
void NI488CC TriggerList    (int boardID, const short * addrlist);
